...
export const AnimatedTestimonials = ({
  ...
  const rotationValues = [-5, -2, 2, 5, 8]
  ...
  // Get a fixed rotation value based on index
              ...
              {testimonials.map((testimonial, index) => (
                <motion.div
                  ...
                  animate={{
                    ...
                    y: isActive(index) ? (clientSide ? [0, -80, 0] : 0) : 0,
                  }}
                  exit={{
                    opacity: 0,
                    scale: 0.9,
                  ...
                  style={{
                    opacity: clientSide ? undefined : 1,
                    transform: clientSide ? undefined : `translateZ(0px) scale(1) rotate(0deg)`
                  }}
                >
                  <img
                    src={testimonial.src}
